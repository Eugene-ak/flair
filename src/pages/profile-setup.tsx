...
import AccomplishmentModal from "../components/modals/AccomplishmentModal";
...
export default function ProfileSetupPage() {
  ...
  const handleAccomplishmentModal = () => {
    setIsAccomplishmentModalOpen(!isAccomplishmentModalOpen);
  };
            ...
            <ul>
              <li>
                ...
                {isEducationModalOpen && (
                  <EducationModal handleClose={handleEducationModal} />
                )}
              </li>
              <li>
                ...
                {isExperienceModalOpen && (
                  <WorkExperienceModal handleClose={handleExperienceModal} />
                )}
              </li>
              <li>
              ...
              <li>
                ...
                <h3>Accomplishments</h3>
                <img src={Plus} alt="add" onClick={handleAccomplishmentModal} />
                <p>Personal achievement & impact</p>
                {isAccomplishmentModalOpen && (
                  <AccomplishmentModal
                    handleClose={handleAccomplishmentModal}
                  />
                )}
              </li>
              <li>
                ...
                <p>CV, portfolio</p>
                {isResumeModalOpen && (
                  <ResumeModal handleClose={handleResumeModal} />
                )}
              </li>
            </ul>
